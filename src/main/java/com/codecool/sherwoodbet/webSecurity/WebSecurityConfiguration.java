...
import com.codecool.sherwoodbet.services.security_service.CustomLoginPageGeneratingFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/","/bet/**", "/signup", "/notsuccesful", "/login","/admin/**", "/removefromDB/**")
                .permitAll()
                .anyRequest()
                .authenticated()
                .and()
    ...
    @Bean
    public MySimpleUrlAuthenticationFailureHandler myFailureHandler() {
